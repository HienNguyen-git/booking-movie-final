            ...
            <div class="admin-section-column">
                <div class="admin-section-panel admin-section-panel2">
                    ...
                    <form action="" method="POST">
                        ...
                        <input placeholder="Name" type="text" name="employeeName" required>
                        <label for="employeePhone">Phone: </label>
                        <input placeholder="Phone" type="text" name="employeePhone" required>
                        <label for="employeeJob">Job: </label>
                        <input placeholder="Job" type="text" name="employeeJob" required>
                        <label for="employeeGender">Gender: </label>
                        <input placeholder="Gender" type="text" name="employeeGender" required>
                        <button type="submit" value="submit" name="submit" class="form-btn">Add Employee</button>
                    </form>
                </div>
            </div>
        </div>
